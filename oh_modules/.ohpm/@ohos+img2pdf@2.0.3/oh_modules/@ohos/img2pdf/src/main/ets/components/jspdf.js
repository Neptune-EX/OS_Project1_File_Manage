...
import { btoa } from "./libs/AtobBtoa";
import { console } from "./libs/console";
//import { PDFSecurity } from "./libs/pdfsecurity.js";
import { toPDFName } from "./libs/pdfname";
/**
...
function jsPDF(options) {
  ...
  var getArrayBuffer = (API.getArrayBuffer = function(data) {
    var len = data.length,
  ...
  var buildDocument = (API.buildDocument = function() {
    resetDocument();
