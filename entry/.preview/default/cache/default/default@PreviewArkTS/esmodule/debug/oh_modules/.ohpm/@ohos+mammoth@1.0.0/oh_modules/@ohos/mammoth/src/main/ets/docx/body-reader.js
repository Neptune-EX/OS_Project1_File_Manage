import * as dingbatToUnicode from '@package:pkg_modules/.ohpm/dingbat-to-unicode@1.0.1/pkg_modules/dingbat-to-unicode/dist/index';
...
import { warning} from '@package:pkg_modules/.ohpm/@ohos+mammoth@1.0.0/pkg_modules/@ohos/mammoth/src/main/ets/results';
import * as xml from '@package:pkg_modules/.ohpm/@ohos+mammoth@1.0.0/pkg_modules/@ohos/mammoth/src/main/ets/xml/index';
import * as transforms from '@package:pkg_modules/.ohpm/@ohos+mammoth@1.0.0/pkg_modules/@ohos/mammoth/src/main/ets/transforms';
import * as uris from '@package:pkg_modules/.ohpm/@ohos+mammoth@1.0.0/pkg_modules/@ohos/mammoth/src/main/ets/docx/uris';
...
export {
    createBodyReader,
    readNumberingProperties as _readNumberingProperties
}
