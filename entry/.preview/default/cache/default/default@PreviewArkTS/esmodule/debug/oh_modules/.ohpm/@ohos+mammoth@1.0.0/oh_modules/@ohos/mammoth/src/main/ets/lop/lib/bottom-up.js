import * as rules from "@package:pkg_modules/.ohpm/@ohos+mammoth@1.0.0/pkg_modules/@ohos/mammoth/src/main/ets/lop/lib/rules";
...
export const parser = function(name, prefixRules, infixRuleBuilders) {
    var self = {
        rule: rule,
...
export const infix = function(name, ruleBuilder) {
    function map(func) {
